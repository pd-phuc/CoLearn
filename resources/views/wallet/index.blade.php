...
@section('content')
    <div class="mx-auto max-w-5xl" x-data="walletPage({{ isset($vietQrModal) && $vietQrModal ? 'true' : 'false' }})">
        {{-- Balance Card --}}
        <div class="mb-8 flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div>
                ...
                <p class="mt-1 text-2xl font-bold text-slate-900">
                    ...
                    <span class="text-base font-medium text-slate-400">đ</span>
                </p>
            </div>
        ...
        >
            ...
            {{-- Custom Amount --}}
            <div class="mt-4">
                <label for="topup-display" class="block text-sm font-medium text-slate-600">
                ...
                <div class="relative mt-1.5">
                    <input
                        ...
                        required
                    />
                    <span class="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-semibold text-orange-400">
                        VNĐ
                    </span>
                    ...
                    <div class="flex items-center justify-between gap-3 px-5 py-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @else
                                ...
                                <a
                                    href="{{ route('wallet.topup.show', $topup->id) }}"
            ...
            <div class="hidden md:block">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-slate-100 bg-slate-50/50">
                        <tr>
                            <th class="px-6 py-3.5 text-xs font-medium text-slate-500">
                ...
                @forelse ($transactions as $tx)
                    <div class="px-5 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="text-sm font-semibold {{ $tx->type === 'in' ? 'text-emerald-600' : 'text-red-600' }}"
                            >
                ...
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-slate-100 bg-slate-50/50">
                        <tr>
                            ...
                            <th class="px-6 py-3.5 text-xs font-medium text-slate-500">
                                {{ __('messages.tx_description') }}
                            </th>
                            <th class="px-6 py-3.5 text-right text-xs font-medium text-slate-500">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse ($transactions as $tx)
                            <tr class="transition-colors hover:bg-slate-50/50">
                                ...
                                <td
                                    class="px-6 py-4 text-right font-semibold {{ $tx->type === 'in' ? 'text-emerald-600' : 'text-red-600' }}"
                                >
