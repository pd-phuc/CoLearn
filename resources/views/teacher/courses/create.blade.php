        ...
        >
            ...
            <div>
                ...
                <input
                    ...
                    value="{{ old('title') }}"
                    required
                    placeholder="{{ __('teacher.course_title_placeholder') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        class="w-full px-4 py-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-500 focus:outline-none font-semibold text-slate-700"
                    >
                        <option value="all" {{ old('level') == 'all' ? 'selected' : '' }}>
            ...
            <div>
                ...
                <textarea
                    name="description"
                    rows="5"
                    placeholder="{{ __('teacher.description_placeholder') }}"
                    class="w-full px-4 py-3 text-sm bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-500 focus:outline-none font-medium"
                >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        placeholder="{{ __('teacher.learning_outcomes_placeholder') }}"
...
{{ old('learning_outcomes') }}</textarea>
                ...
                <div>
                    ...
                    <textarea
                        name="requirements"
                        rows="4"
                        placeholder="{{ __('teacher.requirements_placeholder') }}"
                        class="w-full px-4 py-3 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-500 focus:outline-none font-medium"
                    >
