        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm font-medium">
                    <li>
                        <a href="{{ route('home') }}" class="hover:text-{{ $accentColor }}-400 transition-colors">
                            {{ __('messages.home') }}
                        </a>
                    </li>
                    <li>
                        <a
                            ...
                            class="hover:text-{{ $accentColor }}-400 transition-colors"
                        >
            ...
            <div>
                ...
                <div class="space-y-2 text-sm font-medium">
                    <div class="flex items-center gap-2 text-slate-300">
                        <svg
                            class="w-4 h-4 text-{{ $accentColor }}-500 shrink-0"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                        >
