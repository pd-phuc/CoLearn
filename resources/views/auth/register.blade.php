...
<div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('social.redirect', 'facebook') }}"
                   ...
                   title="{{ __('auth.social_login_facebook') }}">
                    <svg class="w-6 h-6 text-[#1877F2] fill-current transition-transform group-hover:scale-110" viewBox="0 0 24 24">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <!-- Submit Button -->
            <button type="submit" class="w-full btn-primary py-3 text-base font-bold shadow-md shadow-orange-500/20 mt-2">
                {{ __('auth.register') }}
            </button>
        </form>
