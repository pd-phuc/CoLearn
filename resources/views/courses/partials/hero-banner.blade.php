...
<div
    class="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden border border-slate-800 mb-8"
>
    ...
    <div class="relative z-10 space-y-4 max-w-3xl">
        ...
        <div class="flex items-center gap-2 text-xs font-semibold text-slate-400">
            ...
            <span>/</span>
            <a
                href="{{ route('courses.index', ['category' => $course->category->slug]) }}"
        ...
        <div class="flex flex-wrap items-center gap-4 text-xs pt-2">
            <!-- Level Badge -->
            <span
                class="px-2.5 py-1 bg-orange-500/20 text-orange-400 border border-orange-500/30 rounded-md font-bold uppercase tracking-wider"
            >
            ...
            <div class="text-slate-300 font-semibold flex items-center gap-1.5">
                ...
                <span>
                    {{ __('messages.students_count', ['count' => number_format($course->enrollments()->count())]) }}
                </span>
            </div>
            ...
            <div class="flex items-center gap-2 border-l border-slate-800 pl-4">
                <div
                    class="w-6 h-6 rounded-full bg-orange-500 text-white font-bold flex items-center justify-center text-[10px] overflow-hidden ring-1 ring-white/20"
                >
                ...
                <span class="font-semibold text-slate-200">
                    ...
                    <span class="text-white font-bold">{{ $course->teacher->name ?? 'CoLearn Instructor' }}</span>
                </span>
            </div>
        </div>
    </div>
