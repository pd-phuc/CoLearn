...
@section('content')
    <div class="mb-12">
        <!-- Header Banner -->
        <div
            class="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-orange-950 p-8 sm:p-12 text-white mb-8 shadow-xl relative overflow-hidden"
        >
                    ...
                    <div>
                        ...
                        >
                            <option value="newest" {{ request('sort', 'newest') === 'newest' ? 'selected' : '' }}>
                                {{ __('messages.sort_newest') }}
                            </option>
                            <option value="popular" {{ request('sort') === 'popular' ? 'selected' : '' }}>
                                {{ __('messages.sort_popular') }}
                            </option>
                            <option value="price_low" {{ request('sort') === 'price_low' ? 'selected' : '' }}>
                                {{ __('messages.sort_price_low') }}
                            </option>
                            <option value="price_high" {{ request('sort') === 'price_high' ? 'selected' : '' }}>
                                {{ __('messages.sort_price_high') }}
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-2 pt-2">
                        ...
                        @if (request()->anyFilled(['q', 'category', 'level', 'price', 'sort']))
                            <a
                                ...
                                class="block text-center text-xs font-bold text-slate-400 hover:text-slate-600 py-1"
                            >
            ...
            <main class="lg:col-span-9 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse ($courses as $course)
                        <div
                            class="bg-white rounded-2xl border border-slate-200/80 shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col group overflow-hidden hover:-translate-y-1"
                        >
                                ...
                                <div class="space-y-3 pt-3 border-t border-slate-100">
                                    ...
                                    <div class="flex items-center justify-between pt-1">
                                        ...
                                        <a
                                            ...
                                            class="btn-primary text-xs py-2 px-3 font-bold"
                                        >
