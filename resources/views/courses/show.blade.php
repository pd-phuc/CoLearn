            ...
            <main class="lg:col-span-8 space-y-10">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/80 p-8 shadow-xs space-y-4">
                    ...
                    <div class="flex items-start gap-4 pt-2">
                        <div
                            class="w-14 h-14 rounded-full bg-gradient-to-tr from-orange-500 to-amber-500 text-white font-black flex items-center justify-center text-xl shadow-md flex-shrink-0 overflow-hidden ring-2 ring-orange-500/20"
                        >
                        ...
                        <div class="space-y-1">
                            <h3 class="text-base font-extrabold text-slate-900">
                                {{ $course->teacher->name ?? 'Giảng Viên CoLearn' }}
                            </h3>
